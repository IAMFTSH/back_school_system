package graduation.project.register.config;
...
public class SwaggerConfig {
    ...
    public Docket docket(Environment environment){
        //dev环境和test环境
        Profiles profiles=Profiles.of("8001","8002");
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("graduation.project.register.controller"))
                //过滤  只扫描请求路径中符合的
